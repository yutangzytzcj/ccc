...
Transaction e = dao.findById(Integer.valueOf(request.getParameter("id")));
...
if( request.getParameter("Action") != null ) {
    ...
    Business.ProcessTransactions(card.getId());
    response.sendRedirect("DepositRecordList.jsp");
    return;
}
%>
...
<body>
    ...
    <table border="1" cellSpacing="0" borderColorLight="#145aa0" borderColorDark="#9cc7ef" cellPadding="4" width="100%" align="center">
		<tr bgColor="#4296e7">
			<td colSpan="2"><div align="center"><font color="#ffffff">修改还款记录</font></div></td>
		</tr>
		<tr>
			<td><br />
				<div><form action="DepositRecordEdit.jsp" method="post">
...
<%if( e.getCard() != null &&  _CardEntities.get(i).getId().equals(e.getCard())){%>
<option value="<%=_CardEntities.get(i).getId()%>" selected="selected"><%=_CardEntities.get(i).getNo()%></option>
<%}else{%>
...
<%}%>
						...
						<tr style="width: 79%;">
							...
							<td><input id="Title" name="Title" type="text" value="<%=e.getTitle()%>"></td>
						</tr>
						<tr style="width: 79%;">
							<td style="width: 164px;" align="right">日期</td>
							<td><input id="Time" name="Time" type="text" value="<%=e.getTime()%>"></td>
						</tr>
						<tr style="width: 79%;">
							<td style="width: 164px;" align="right">金额</td>
							<td><input id="Amount" name="Amount" type="text" value="<%=e.getAmount()%>"></td>
						</tr>
