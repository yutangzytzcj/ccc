...
<body>
    ...
    <table border="1" cellSpacing="0" borderColorLight="#145aa0" borderColorDark="#9cc7ef" cellPadding="4" width="100%" align="center">
		<tr bgColor="#4296e7">
			<td colSpan="2"><div align="center"><font color="#ffffff">修改个人信息</font></div></td>
		</tr>
		<tr>
			<td><br />
				<div><form action="" method="post" onsubmit="return check();">
                    ...
                    <table style="border-width: 1px; border-style: solid; width: 100%; height: 50px; border-collapse: collapse;"
						...
						<tr style="width: 79%;">
							...
							<td><input id="Mobile" name="Mobile" type="text" value="<%=e.getMobile()%>" onkeypress="return event.keyCode>=48&&event.keyCode<=57||event.keyCode==46"></td>
						</tr>
						<tr style="width: 79%;">
							<td style="width: 164px;" align="right">身份证号</td>
							<td><input id="IdNo" name="IdNo" type="text" value="<%=e.getIdNo()%>" onkeypress="return event.keyCode>=48&&event.keyCode<=57||event.keyCode==46"></td>
						</tr>
