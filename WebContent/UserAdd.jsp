...
<body>
    ...
    <table border="1" cellSpacing="0" borderColorLight="#145aa0" borderColorDark="#9cc7ef" cellPadding="4" width="100%" align="center">
		<tr bgColor="#4296e7">
			<td colSpan="2"><div align="center"><font color="#ffffff">添加用户</font></div></td>
		</tr>
		<tr>
			<td><br />
                            <div><form action="UserAdd.jsp" method="post" onsubmit="return check();">
					<input type="hidden" name="Action" value="insert" />
					<input type="hidden" name="Status" value="未注册" />
                    <table style="border-width: 1px; border-style: solid; width: 100%; height: 50px; border-collapse: collapse;"
						...
						<tr style="width: 79%;">
							...
							<td><input id="IdNo" name="IdNo" type="text" value="" ></td>
						</tr>
