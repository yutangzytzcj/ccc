...
<table border="1" cellSpacing="0" borderColorLight="#145aa0" borderColorDark="#9cc7ef" cellPadding="4" width="100%" align="center">
	<tr bgColor="#4296e7"><td colSpan="2"><div align="center"><font color="#ffffff">Setting管理</font></div></td></tr>
	<tr>
		<td><br><div>
			...
			<tr style="font-style: normal; font-weight: normal; text-decoration: none; background-color: white; font-size:10pt;" align="center">
				<td><%=e.getId()%></td>
				<td><%=e.getMinPayRate()%></td>
				<td><%=e.getInterestRate()%></td>
				<td><%=e.getOverDays()%></td>
				<td><%=e.getBillDate()%></td>
				<td>
					<a href="SettingEdit.jsp?id=<%=e.getId()%>">修改</a> 
	...
	<tr bgColor="#4296e7"><td colSpan="2"><a style="color: white;" href="SettingAdd.jsp">新建</a></td></tr>
</table>
